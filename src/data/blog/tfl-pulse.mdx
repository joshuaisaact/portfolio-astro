...
date: "2025-01-06"
featured_image: "./gopher.webp"
excerpt: "How I learned Go by building a real-time London Underground tracker, featuring concurrent polling, WebSockets, and lots of debugging."
tags: ["Go", "Backend", "APIs", "WebSockets", "Concurrency", "Learning"]
---

import Figure from '../../components/Figure.astro';
import drakeEnumImg from './drake-enum.png';
import tflMvpImg from './tfl-pulse-mvp.webp';
