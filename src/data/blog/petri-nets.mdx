...
Nobody built the tooling.<Footnote id="3" />
...
The irony is that Petri nets are quietly powering enterprise software already. [BPMN](https://en.wikipedia.org/wiki/Business_Process_Model_and_Notation) engines like [Camunda](https://camunda.com/) run token-based semantics derived directly from Petri net theory.<Footnote id="4" /> The process mining industry uses them as a core formalism.<Footnote id="5" /> But nobody calls them Petri nets. The most successful deployment of the theory is invisible to the people who would benefit most from understanding it.
...
<FootnoteList>
  <FootnoteItem id="1">If you have heard of it, well done! It comes from Carl Adam Petri's 1962 PhD dissertation at the University of Bonn, "Kommunikation mit Automaten." I canvassed friends before writing this — none of them had heard of it. So you are in a minority!</FootnoteItem>
  ...
  <FootnoteItem id="3">Since publishing this article, I've built [petri-ts](https://www.npmjs.com/package/petri-ts), a TypeScript Petri net library available on npm. The engine, analyser, and examples from this post are all there. So now someone has.</FootnoteItem>
  <FootnoteItem id="4">Dijkman, Dumas, and Ouyang formally mapped BPMN to Petri nets in their 2007 paper. Every BPMN construct (sequence flows, parallel gateways, inclusive gateways) has a precise Petri net translation.</FootnoteItem>
  <FootnoteItem id="5">Wil van der Aalst, widely considered the father of process mining and Chief Scientist at Celonis (valued at $13B+), built the field on Petri net discovery algorithms. His textbook *Process Mining* is essentially applied Petri net theory.</FootnoteItem>
</FootnoteList>
