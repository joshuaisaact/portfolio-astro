...
But I wanted to see how it compared to production code. Benchmarking against Zig's `std.HashMap` (which uses [SwissTable](https://abseil.io/about/design/swisstables) under the hood) sent me down more rabbit holes.<Footnote id="7" /> The final implementation combines:
