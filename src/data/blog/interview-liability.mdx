...
The research is damning. A North Carolina State/Microsoft study found that candidates in traditional whiteboard interviews performed half as well as those given the same problem privately.<Footnote id="7" /> The format tests anxiety, not competence. All women in the public condition failed; all women in the private condition passed—same problem, same skill level, different environment.<Footnote id="8" /> If you've ever wondered why engineering struggles to retain women, consider that we've built a filter optimised to reject them. A 2025 study of 131 software engineering candidates found zero correlation between weekly LeetCode practice hours and interview readiness—while communication practice and peer mock interviews showed twice the effect.<Footnote id="9" /> Isolated algorithmic assessments have validity coefficients of 0.31–0.42, explaining just 10–18% of job performance. Combine them with work samples and structured interviews? That jumps to 0.63–0.65.<Footnote id="10" /> We know how to do this better. We just don't.
...
<FootnoteList>
  ...
  <FootnoteItem id="8">Same study. The researchers note this likely reflects performance anxiety patterns, not ability differences—the private condition proved the point.</FootnoteItem>
  <FootnoteItem id="9">[Bell et al. 2025](https://arxiv.org/abs/2507.02068). Study of 131 candidates (professionals averaging 9 years experience, plus students). Communication practice showed approximately 2× the effect on perceived readiness.</FootnoteItem>
  <FootnoteItem id="10">[Sackett et al. 2021](https://www.criteriacorp.com/blog/updates-employee-selection-science), revising Schmidt & Hunter's landmark 1998 meta-analysis. Multimethod assessment more than doubles explained variance in job performance.</FootnoteItem>
